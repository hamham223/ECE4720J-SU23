...
Official tuturial for drill on hadoop (with zookeeper): https://drill.apache.org/docs/installing-drill-on-the-cluster/
...
Drill can also deal with data in avro format, parquet format, etc. with a faster speed.python